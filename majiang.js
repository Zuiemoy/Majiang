...
function allLoseVisibility() {
    let winCheck = 0;
    if (eastWinCheck.checked == true) winCheck++;
    if (westWinCheck.checked == true) winCheck++;
    if (southWinCheck.checked == true) winCheck++;
    if (northWinCheck.checked == true) winCheck++;
    if (winCheck >= 2) {
        document.getElementById("allLoseCheck").checked = false;
...
document.getElementById("eastWinCheck").onchange = function() {
    if (this.checked) {
        document.getElementById("eastLoseCheck").checked = false;
...
document.getElementById("southWinCheck").onchange = function() {
    if (this.checked) {
        document.getElementById("southLoseCheck").checked = false;
...
document.getElementById("westWinCheck").onchange = function() {
    if (this.checked) {
        document.getElementById("westLoseCheck").checked = false;
...
document.getElementById("northWinCheck").onchange = function() {
    if (this.checked) {
        document.getElementById("northLoseCheck").checked = false;
    ...
    //}
        ...
        if (eastCoverNo * southCoverNo * westCoverNo * northCoverNo == 0) {
            ...
            if (document.getElementById("eastLoseCheck").checked) {
                eastScore[gameCount] = -1 * (southScore[gameCount] + westScore[gameCount] + northScore[gameCount]);
                console.log(`东方冲牌，东方${eastScore[gameCount]}`);
            }
            if (document.getElementById("southLoseCheck").checked) {
                southScore[gameCount] = -1 * (eastScore[gameCount] + westScore[gameCount] + northScore[gameCount]);
                console.log(`南方冲牌，南方${southScore[gameCount]}`);
            }
            if (document.getElementById("westLoseCheck").checked) {
                westScore[gameCount] = -1 * (eastScore[gameCount] + southScore[gameCount] + northScore[gameCount]);
                console.log(`西方冲牌，西方${westScore[gameCount]}`);
            }
            if (document.getElementById("northLoseCheck").checked) {
                northScore[gameCount] = -1 * (eastScore[gameCount] + southScore[gameCount] + westScore[gameCount]);
        ...
        document.getElementById("eastScoreTd").innerText = roundArray(eastScore).join(`\n\n`);
        document.getElementById("southScoreTd").innerText = roundArray(southScore).join(`\n\n`);
        document.getElementById("westScoreTd").innerText = roundArray(westScore).join(`\n\n`);
        document.getElementById("northScoreTd").innerText = roundArray(northScore).join(`\n\n`);
        ...
        document.getElementById("eastTotalTd").innerText = eastTotal.toFixed(1);
        document.getElementById("southTotalTd").innerText = southTotal.toFixed(1);
        document.getElementById("westTotalTd").innerText =  westTotal.toFixed(1);
        document.getElementById("northTotalTd").innerText =  northTotal.toFixed(1);
...
document.getElementById("prevGame").onclick = function() {
    ...
    // 放炮里隐藏赢家
    allLoseVisibility();
    if (document.getElementById("eastWinCheck").checked == true) {
        document.getElementById("eastLoseCheck").style.visibility = "hidden";
        document.getElementById("eastLose").style.visibility = "hidden";
    }
    if (document.getElementById("southWinCheck").checked == true) {
        document.getElementById("southLoseCheck").style.visibility = "hidden";
        document.getElementById("southLose").style.visibility = "hidden";
    }
    if (document.getElementById("westWinCheck").checked == true) {
        document.getElementById("westLoseCheck").style.visibility = "hidden";
        document.getElementById("westLose").style.visibility = "hidden";
    }
    if (document.getElementById("northWinCheck").checked == true) {
        document.getElementById("northLoseCheck").style.visibility = "hidden";
        document.getElementById("northLose").style.visibility = "hidden";
    }
    // 显示游戏局数
...
document.getElementById("nextGame").onclick = function() {
    ...
    // 隐藏赢家多余选项
    eastWin = document.getElementsByClassName("eastWin");
    for (let element of eastWin) {
        element.style.display = "none";
    }
    southWin = document.getElementsByClassName("southWin");
    for (let element of southWin) {
        element.style.display = "none";
    }
    westWin = document.getElementsByClassName("westWin");
    for (let element of westWin) {
        element.style.display = "none";
    }
    northWin = document.getElementsByClassName("northWin");
    for (let element of northWin) {
        element.style.display = "none";
    }
    // 显示计分选项
    inGame = document.getElementsByClassName("inGame");
...
function roundArray(scoreArray) {
    let i = 0;
    while (i < scoreArray.length) {
        scoreArray[i] = Number(scoreArray[i].toFixed(1));
        i++;
    }
    return scoreArray;
}

document.getElementById("eastWinCheck").onclick = function() {
    eastWin = document.getElementsByClassName("eastWin");
    if(this.checked) {
        for (let element of eastWin) {
            element.style.display = "inline";
...
document.getElementById("southWinCheck").onclick = function() {
    southWin = document.getElementsByClassName("southWin");
    if(this.checked) {
        for (let element of southWin) {
            element.style.display = "inline";
...
document.getElementById("westWinCheck").onclick = function() {
    westWin = document.getElementsByClassName("westWin");
    if(this.checked) {
        for (let element of westWin) {
            element.style.display = "inline";
...
document.getElementById("northWinCheck").onclick = function() {
    northWin = document.getElementsByClassName("northWin");
    if(this.checked) {
        for (let element of northWin) {
            element.style.display = "inline";
